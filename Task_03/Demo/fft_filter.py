...
# filename = sys.argv[1]
img = cv2.imread(r"C:\Users\richa\OneDrive\Documentos\Computer Vision\Computer-Vision-Course\Task_03\Demo\imagens\lion.jpg",0)
...
filter_mask[(l//2)-1:int(np.ceil(l/2))+2,(c//2)-1:int(np.ceil(c/2))+2] = mask
